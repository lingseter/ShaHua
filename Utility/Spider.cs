...
namespace Utility
{
    public class Spider
    {
        ...
        private void RequestResource(int index)
        {
            ...
            {
                LogHelper.SimpleLog("RequestResource ", we.Message + url + we.Status);
            }
        }
        ...
        private void ReceivedResource(IAsyncResult ar)
        {
            ...
            {
                LogHelper.SimpleLog("ReceivedResource ", we.Message + url + we.Status);
            }
            catch (Exception e)
            {
                LogHelper.SimpleLog("Exception", e.Message);
            }
        }
        ...
        private void ReceivedData(IAsyncResult ar)
        {
            ...
            {
                LogHelper.SimpleLog("ReceivedData Web ", we.Message + url + we.Status);
            }
            catch (Exception e)
            {
                LogHelper.SimpleLog("Exception", e.GetType().ToString() + e.Message);
            }
        }
        ...
        private void SaveContents(string html, string url)
        {
            ...
            {
                LogHelper.SimpleLog("SaveContents IO", ioe.Message + " path=" + path);
            }
